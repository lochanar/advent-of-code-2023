...
try {
    ...
    for (let line of lines) {
        ...
        for (let e=extrapolation.length - 1; e > 0; e--) {
            const lastFirstElement = extrapolation[e][0];
            const nextFirstElement = extrapolation[e-1][0];
            const x = nextFirstElement - lastFirstElement;
            extrapolation[e-1].unshift(x);
        }
